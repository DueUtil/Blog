(function(g){var window=this;'use strict';var jQa=function(a,b){return g.Tb(a,b)},kQa=function(a,b){b=b instanceof g.Kc?b:g.Qc(b,/^data:image\//i.test(b));
a.src=g.Lc(b)},lQa=function(a){if(a instanceof g.Qh)return a;
...
c.next=c.i.bind(c);return c}throw Error("Not implemented");},mQa=function(a,b,c){if(g.La(a))try{g.Db(a,b,c)}catch(d){if(d!==g.Zh)throw d;
}else{a=lQa(a);try{for(;;)b.call(c,a.i(),void 0,a)}catch(d){if(d!==g.Zh)throw d;}}},N6=function(a){g.Yj(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Qa()).toString(36));
return a},O6=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.dk(a.u,b,c)},nQa=function(a,b){var c=[];
mQa(b,function(d){try{var e=g.kr.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.jr(e)&&c.push(d)},a);
return c},oQa=function(a,b){nQa(a,b).forEach(function(c){g.kr.prototype.remove.call(this,c)},a)},pQa=function(a){if(a.V){if(a.V.locationOverrideToken)return{locationOverrideToken:a.V.locationOverrideToken};
if(null!=a.V.latitudeE7&&null!=a.V.longitudeE7)return{latitudeE7:a.V.latitudeE7,longitudeE7:a.V.longitudeE7}}return null},qQa=function(a,b){g.jb(a,b)||a.push(b)},P6=function(a){var b=0,c;
for(c in a)b++;return b},rQa=function(a){try{return g.C.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},Q6=function(a){if(g.C.JSON)try{return g.C.JSON.parse(a)}catch(b){}return rQa(a)},sQa=function(a,b,c,d){var e=new g.Qj(null,void 0);
...
g.Go(b.split(","),g.Pa(jQa,vQa)).forEach(function(c){a.capabilities.add(c)})},uQa=function(a,b){a.experiments.clear();
...
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},xQa=function(a){return new T6(a)},yQa=function(a){return Array.isArray(a)?g.Se(a,xQa):[]},V6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},W6=function(a){return Array.isArray(a)?"["+g.Se(a,V6).join(",")+"]":"null"},X6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},zQa=function(a){return g.Se(a,function(b){return{key:b.id,
name:b.name}})},Y6=function(a,b){return g.fb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},Z6=function(a,b){return g.fb(a,function(c){return U6(c,b)})},AQa=function(){var a=(0,g.uz)();
a&&oQa(a,a.i.Jg(!0))},$6=function(){var a=g.xz("yt-remote-connected-devices")||[];
g.Ab(a);return a},BQa=function(a){if(g.kb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Se(a,function(d,e){return 0==e?d:d.substring(c.length)})},CQa=function(a){g.wz("yt-remote-connected-devices",a,86400)},b7=function(){if(a7)return a7;
...
g.jb(a,b);g.Az()&&g.Cb(a,b);a=BQa(a);if(g.kb(a))try{g.At("remote_sid")}catch(c){}else try{g.xt("remote_sid",a.join(","),-1)}catch(c){}},DQa=function(){return g.xz("yt-remote-session-browser-channel")},EQa=function(){return g.xz("yt-remote-local-screens")||[]},FQa=function(){g.wz("yt-remote-lounge-token-expiration",!0,86400)},GQa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Se(EQa(),function(d){return d.loungeToken}),c=g.Se(a,function(d){return d.loungeToken});
g.vm(c,function(d){return!g.jb(b,d)})&&FQa();
g.wz("yt-remote-local-screens",a,31536E3)},HQa=function(a,b){g.wz("yt-remote-session-browser-channel",a);
g.wz("yt-remote-session-screen-id",b);a=$6();b=b7();g.jb(a,b)||a.push(b);CQa(a);c7()},d7=function(a){a||(g.zz("yt-remote-session-screen-id"),g.zz("yt-remote-session-video-id"));
c7();a=$6();g.ob(a,b7());CQa(a)},IQa=function(){if(!e7){var a=g.ur();
a&&(e7=new g.er(a))}},JQa=function(){IQa();
...
d.onerror=b;c&&(d.onload=c);g.Rk(d,g.Tq(a));(document.head||document.documentElement).appendChild(d)},OQa=function(){var a=f7(),b=[];
...
var a=OQa();a.push.apply(a,g.v(RQa.map(NQa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");g7(a)},j7=function(a,b,c){g.H.call(this);
...
return g.C.setTimeout(function(){a()},b)},p7=function(a){o7.dispatchEvent(new TQa(o7,a))},TQa=function(a,b){g.nf.call(this,"statevent",a);
this.stat=b},q7=function(a,b,c,d){this.i=a;
this.u=b;this.N=c;this.K=d||1;this.B=45E3;this.C=new g.ek(this);this.J=new g.kh;this.J.setInterval(250)},VQa=function(a,b,c){a.Ss=1;
a.Gm=N6(b.clone());a.eq=c;a.D=!0;UQa(a,null)},r7=function(a,b,c,d,e){a.Ss=1;
a.Gm=N6(b.clone());a.eq=null;a.D=c;e&&(a.bM=!1);UQa(a,d)},UQa=function(a,b){a.Hs=Date.now();
s7(a);a.Vn=a.Gm.clone();O6(a.Vn,"t",a.K);a.yA=0;a.If=a.i.oC(a.i.Dw()?b:null);0<a.lB&&(a.Kz=new k7((0,g.D)(a.cN,a,a.If),a.lB));a.C.Sa(a.If,"readystatechange",a.UO);b=a.Go?g.$b(a.Go):{};a.eq?(a.vA="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.If.send(a.Vn,a.vA,a.eq,b)):(a.vA="GET",a.bM&&!g.ng&&(b.Connection="close"),a.If.send(a.Vn,a.vA,null,b));a.i.tj(1)},XQa=function(a,b){var c=a.yA,d=b.indexOf("\n",c);
if(-1==d)return t7;c=Number(b.substring(c,d));if(isNaN(c))return WQa;d+=1;if(d+c>b.length)return t7;b=b.substr(d,c);a.yA=d+c;return b},ZQa=function(a,b){a.Hs=Date.now();
...
a.B;
$Qa(a,a.B)},$Qa=function(a,b){if(null!=a.gt)throw Error("WatchDog timer not null");
...
g.hf(a.Kz);a.Kz=null;a.J.stop();g.gk(a.C);if(a.If){var b=a.If;a.If=null;b.abort();b.dispose()}a.Jj&&(a.Jj=null)},y7=function(a,b){try{a.i.mL(a,b),a.i.tj(4)}catch(c){}},bRa=function(a,b,c,d,e){if(0==d)c(!1);
...
this.u=new m7},dRa=function(a){var b=A7(a.i,a.mu,"/mail/images/cleardot.gif");
N6(b);bRa(b.toString(),5E3,(0,g.D)(a.OP,a),3,2E3);a.tj(1)},C7=function(a){var b=a.i.N;
if(null!=b)p7(5),b?(p7(11),B7(a.i,a,!1)):(p7(12),B7(a.i,a,!0));else if(a.nh=new q7(a,void 0,void 0,void 0),a.nh.Go=a.mB,b=a.i,b=A7(b,b.Dw()?a.Mt:null,a.nB),p7(5),!g.ke||g.ce(10))O6(b,"TYPE","xmlhttp"),r7(a.nh,b,!1,a.Mt,!1);else{O6(b,"TYPE","html");var c=a.nh;a=!!a.Mt;c.Ss=3;c.Gm=N6(b.clone());ZQa(c,a)}},D7=function(a,b,c){this.Ra=1;
this.i=[];this.B=[];this.C=new m7;this.K=a||null;this.N=null!=b?b:null;this.D=c||!1},eRa=function(a,b){this.i=a;
this.map=b;this.context=null},fRa=function(a,b,c,d){g.nf.call(this,"timingevent",a);
this.size=b;this.ww=d},gRa=function(a){g.nf.call(this,"serverreachability",a)},jRa=function(a){hRa(a);
if(3==a.Ra){var b=a.Mv++,c=a.Nx.clone();g.Yj(c,"SID",a.u);g.Yj(c,"RID",b);g.Yj(c,"TYPE","terminate");E7(a,c);b=new q7(a,a.u,b,void 0);b.Ss=2;b.Gm=N6(c.clone());kQa(new Image,b.Gm.toString());b.Hs=Date.now();s7(b)}iRa(a)},kRa=function(a){a.oQ(1,0);
a.Nx=A7(a,null,a.oB);F7(a)},hRa=function(a){a.Lm&&(a.Lm.abort(),a.Lm=null);
a.De&&(a.De.cancel(),a.De=null);a.ul&&(g.C.clearTimeout(a.ul),a.ul=null);G7(a);a.Ug&&(a.Ug.cancel(),a.Ug=null);a.Um&&(g.C.clearTimeout(a.Um),a.Um=null)},lRa=function(a,b){if(0==a.Ra)throw Error("Invalid operation: sending map when state is closed");
a.i.push(new eRa(a.XR++,b));2!=a.Ra&&3!=a.Ra||F7(a)},mRa=function(a){var b=0;
a.De&&b++;a.Ug&&b++;return b},F7=function(a){a.Ug||a.Um||(a.Um=n7((0,g.D)(a.rL,a),0),a.Dr=0)},oRa=function(a,b){if(1==a.Ra){if(!b){a.Mv=Math.floor(1E5*Math.random());
b=a.Mv++;var c=new q7(a,"",b,void 0);c.Go=a.Vj;var d=H7(a),e=a.Nx.clone();g.Yj(e,"RID",b);g.Yj(e,"CVER","1");E7(a,e);VQa(c,e,d);a.Ug=c;a.Ra=2}}else 3==a.Ra&&(b?nRa(a,b):0==a.i.length||a.Ug||nRa(a))},nRa=function(a,b){if(b)if(6<a.Zo){a.i=a.B.concat(a.i);
a.B.length=0;var c=a.Mv-1;b=H7(a)}else c=b.N,b=b.eq;else c=a.Mv++,b=H7(a);var d=a.Nx.clone();g.Yj(d,"SID",a.u);g.Yj(d,"RID",c);g.Yj(d,"AID",a.Wr);E7(a,d);c=new q7(a,a.u,c,a.Dr+1);c.Go=a.Vj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Ug=c;VQa(c,d,b)},E7=function(a,b){a.Jf&&(a=a.Jf.NI())&&g.Gb(a,function(c,d){g.Yj(b,d,c)})},H7=function(a){var b=Math.min(a.i.length,1E3),c=["count="+b];
...
return c.join("&")},pRa=function(a){a.De||a.ul||(a.J=1,a.ul=n7((0,g.D)(a.qL,a),0),a.dr=0)},I7=function(a){if(a.De||a.ul||3<=a.dr)return!1;
a.J++;a.ul=n7((0,g.D)(a.qL,a),qRa(a,a.dr));a.dr++;return!0},B7=function(a,b,c){a.tA=c;
a.Wj=b.Xk;a.D||kRa(a)},G7=function(a){null!=a.kp&&(g.C.clearTimeout(a.kp),a.kp=null)},qRa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},J7=function(a,b){if(2==b||9==b){var c=null;
a.Jf&&(c=null);var d=(0,g.D)(a.iW,a);c||(c=new g.Qj("//www.google.com/images/cleardot.gif"),N6(c));aRa(c.toString(),1E4,d)}else p7(2);rRa(a,b)},rRa=function(a,b){a.Ra=0;
a.Jf&&a.Jf.bI(b);iRa(a);hRa(a)},iRa=function(a){a.Ra=0;
...
if(""!=d.i)b&&g.Sj(d,b+"."+d.i),g.Tj(d,d.B);else{var e=window.location;d=sQa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Ku&&g.Gb(a.Ku,function(f,h){g.Yj(d,h,f)});
g.Yj(d,"VER",a.Zo);E7(a,d);return d},sRa=function(){},tRa=function(){this.i=[];
...
e=void 0===e?!1:e;this.xa=a;this.J=b;this.B=new g.dr;this.u=new K7(this.NV,this);this.i=null;this.ea=!1;this.D=null;this.V="";this.N=this.C=0;this.K=[];this.Aa=c;this.ma=d;this.Ca=e},vRa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.tA,sessionId:a.i.u,arrayId:a.i.Wr}},wRa=function(a,b){a.N=b||0;
a.u.stop();M7(a);a.i&&(3==a.i.getState()&&oRa(a.i),jRa(a.i));a.N=0},N7=function(a){return!!a.i&&3==a.i.getState()},M7=function(a){if(a.i){var b=a.ma(),c=a.i.Vj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Pa(a.C,d,!0),onError:g.Pa(a.B,e),onTimeout:g.Pa(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.lt(b,a)},ARa=function(){var a=xRa;
yRa();R7.push(a);zRa()},S7=function(a,b){yRa();
var c=BRa(a,String(b));g.kb(R7)?CRa(c):(zRa(),g.Db(R7,function(d){d(c)}))},yRa=function(){R7||(R7=g.Ha("yt.mdx.remote.debug.handlers_")||[],g.Ga("yt.mdx.remote.debug.handlers_",R7,void 0))},CRa=function(a){var b=(T7+1)%50;
...
this.J=a;this.screens=[]},ERa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
...
this.u=a;this.i=NaN;Y7(this);this.info("Initializing with "+W6(this.screens))},HRa=function(a){if(a.screens.length){var b=g.Se(a.screens,function(d){return d.id}),c=P7(a.u,"/pairing/get_lounge_token_batch");
Q7(a.u,c,{screen_ids:b.join(",")},(0,g.D)(a.MQ,a),(0,g.D)(a.LQ,a))}},Y7=function(a){if(g.hs("deprecate_pair_servlet_enabled"))return FRa(a,[]);
var b=yQa(EQa());b=g.Go(b,function(c){return!c.uuid});
return FRa(a,b)},$7=function(a,b){GQa(g.Se(a.screens,wQa));
...
else{c=g.Ob(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(a8("Updated online screens: "+g.Jh(a.i)),a.i=b,a.Z("screenChange"));IRa(a)},e8=function(a){isNaN(a.B)||g.gt(a.B);
a.B=g.et((0,g.D)(a.FE,a),0<a.C&&a.C<g.Qa()?2E4:1E4)},a8=function(a){S7("OnlineScreenService",a)},JRa=function(a){var b={};
g.Db(a.J(),function(c){c.token?b[c.token]=c.id:this.Zd("Requesting availability of screen w/o lounge token.")});
return b},IRa=function(a){a=g.Ob(g.Hb(a.i,function(b){return b}));
...
W7.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};KRa(this)},MRa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Hh(),l=c?Z6(h,c):null;c&&(a.K||l)||(l=Z6(h,b));if(l){l.uuid=b;var m=g8(a,l);c8(a.i,m,function(n){e(n?m:null)})}else c?LRa(a,c,(0,g.D)(function(n){var p=g8(this,new T6({name:d,
...
g.lt(P7(a.C,"/pairing/get_lounge_token_batch"),e)},PRa=function(a){a.screens=a.u.Hh();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+W6(a.screens))},KRa=function(a){h8(a);
a.u=new Z7(a.C);a.u.subscribe("screenChange",(0,g.D)(a.VQ,a));PRa(a);a.K||(a.B=yQa(g.xz("yt-remote-automatic-screen-cache")||[]));h8(a);a.info("Initializing automatic screens: "+W6(a.B));a.i=new b8(a.C,(0,g.D)(a.Hh,a,!0));a.i.subscribe("screenChange",(0,g.D)(function(){this.Z("onlineScreenChange")},a))},g8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=Z6(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||QRa(a));h8(a);a.D[b.uuid]=b.id;g.wz("yt-remote-device-id-map",a.D,31536E3);return b},QRa=function(a){a=g.Go(a.B,function(b){return"shortLived"!=b.idType});
g.wz("yt-remote-automatic-screen-cache",g.Se(a,wQa))},h8=function(a){a.D=g.xz("yt-remote-device-id-map")||{}},i8=function(a,b,c){g.R.call(this);
this.Ca=c;this.B=a;this.i=b;this.C=null},j8=function(a,b){a.C=b;
a.Z("sessionScreen",a.C)},RRa=function(a,b){a.C&&(a.C.token=b,g8(a.B,a.C));
a.Z("sessionScreen",a.C)},k8=function(a,b){S7(a.Ca,b)},l8=function(a,b,c){i8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.ma=(0,g.D)(this.ZO,this);this.Aa=(0,g.D)(this.pV,this);this.ea=g.et(function(){SRa(d,null)},12E4);
this.K=this.D=this.J=this.N=0;this.xa=!1;this.V="unknown"},m8=function(a,b){g.gt(a.K);
a.K=0;0==b?TRa(a):a.K=g.et(function(){TRa(a)},b)},TRa=function(a){URa(a,"getLoungeToken");
g.gt(a.D);a.D=g.et(function(){VRa(a,null)},3E4)},URa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.Jh(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ia,(0,g.D)(function(){k8(this,"Failed to send message: "+b+".")},a)):k8(a,"Sending yt message without session: "+g.Jh(c))},n8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.cJ(b,function(c){j8(a,c)},function(){return a.wg()},5)):a.wg(Error("Waiting for session status timed out."))},XRa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new T6(b);WRa(a,d,function(e){e?(a.xa=!0,g8(a.B,d),j8(a,d),a.V="unknown",m8(a,c)):(g.ms(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.wg())},5)},SRa=function(a,b){g.gt(a.ea);
...
".")),n8(a,b.screenId)):n8(a,b.screenId):a.wg(Error("Waiting for session status timed out."))},VRa=function(a,b){g.gt(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.V=c,m8(a,3E4)):(RRa(a,b.loungeToken),a.xa=!1,a.V="unknown",m8(a,b.loungeTokenRefreshIntervalMs))},WRa=function(a,b,c,d){g.gt(a.J);
a.J=0;ORa(a.B,b,function(e){e||0>d?c(e):a.J=g.et(function(){WRa(a,b,c,d-1)},300)})},YRa=function(a){g.gt(a.N);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},ZRa=function(a){a.D=a.B.IG(a.Aa,a.i.label,a.i.friendlyName,p8(a),function(b,c){a.D=g.Ia;
a.ma=!0;j8(a,b);"shortLived"==b.idType&&0<c&&q8(a,c)},function(b){a.D=g.Ia;
a.wg(b)})},$Ra=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.Ka;JQa()&&(b.env_useStageMdx=1);return g.qi(b)},r8=function(a){return new Promise(function(b){a.Aa=X6();
if(a.La){var c=new chrome.cast.DialLaunchResponse(!0,$Ra(a));b(c);ZRa(a)}else a.ea=function(){g.gt(a.V);a.ea=function(){};
a.V=NaN;var d=new chrome.cast.DialLaunchResponse(!0,$Ra(a));b(d);ZRa(a)},a.V=g.et(function(){a.ea()},100)})},bSa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new T6(b);return(new Promise(function(e){aSa(a,d,function(f){f?(a.ma=!0,g8(a.B,d),j8(a,d),q8(a,c)):g.ms(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):r8(a)})},cSa=function(a,b){var c=a.N.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){MRa(a.B,c,b,d,function(f){f&&f.token&&j8(a,f);e(f)},function(f){k8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):r8(a)})},aSa=function(a,b,c,d){g.gt(a.J);
a.J=0;ORa(a.B,b,function(e){e||0>d?c(e):a.J=g.et(function(){aSa(a,b,c,d-1)},300)})},q8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
...
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.xa=c,q8(a,3E4)):(a.ma=!1,a.xa="unknown",RRa(a,b.loungeToken),q8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.xa="noLoungeTokenResponse";q8(a,3E4)})},eSa=function(a){g.gt(a.J);
...
this.config_=b;this.u=a;this.N=b.appId||"233637DE";this.C=b.theme||"cl";this.V=b.disableCastApi||!1;this.J=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.D)(this.lU,this)},fSa=function(a,b){return b?g.fb(a.B,function(c){return U6(b,c.label)},a):null},u8=function(a){S7("Controller",a)},xRa=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},v8=function(a){return a.K||!!a.B.length||!!a.i},w8=function(a,b,c){b!=a.i&&(g.hf(a.i),(a.i=b)?(c?a.Z("yt-remote-cast2-receiver-resumed",
b.i):a.Z("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.D)(a.pL,a,b)),b.subscribe("sessionFailed",function(){return gSa(a,b)}),b.getScreen()?a.Z("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Xr(null)):a.Z("yt-remote-cast2-session-change",null))},gSa=function(a,b){a.i==b&&a.Z("yt-remote-cast2-session-failed")},hSa=function(a){var b=a.u.HG(),c=a.i&&a.i.i;
a=g.Se(b,function(d){c&&U6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=fSa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},mSa=function(a,b,c,d){d.disableCastApi?x8("Cannot initialize because disabled by Mdx config."):iSa()?jSa(b,d)&&(y8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?kSa(a,c):(window.__onGCastApiAvailable=function(e,f){e?kSa(a,c):(z8("Failed to load cast API: "+f),A8(!1),y8(!1),g.zz("yt-remote-cast-available"),g.zz("yt-remote-cast-receiver"),
...
var a=B8();a&&a.dispose();g.Ga("yt.mdx.remote.cloudview.instance_",null,void 0);nSa(!1);g.Uu(C8);C8.length=0},D8=function(){return!!g.xz("yt-remote-cast-installed")},oSa=function(){var a=g.xz("yt-remote-cast-receiver");
return a?a.friendlyName:null},pSa=function(){x8("clearCurrentReceiver");
g.zz("yt-remote-cast-receiver")},qSa=function(){return D8()?B8()?B8().getCastSession():(z8("getCastSelector: Cast is not initialized."),null):(z8("getCastSelector: Cast API is not installed!"),null)},F8=function(){D8()?B8()?E8()?(x8("Requesting cast selector."),B8().requestSession()):(x8("Wait for cast API to be ready to request the session."),C8.push(g.Tu("yt-remote-cast2-api-ready",F8))):z8("requestCastSelector: Cast is not initialized."):z8("requestCastSelector: Cast API is not installed!")},G8=
...
return g.dj||a},rSa=function(a,b){B8().init(a,b)},jSa=function(a,b){var c=!1;
...
x8("cloudview.createSingleton_: "+c);return c},B8=function(){return g.Ha("yt.mdx.remote.cloudview.instance_")},kSa=function(a,b){A8(!0);
y8(!1);rSa(a,function(c){c?(nSa(!0),g.Vu("yt-remote-cast2-api-ready")):(z8("Failed to initialize cast API."),A8(!1),g.zz("yt-remote-cast-available"),g.zz("yt-remote-cast-receiver"),lSa());b(c)})},x8=function(a){S7("cloudview",a)},z8=function(a){S7("cloudview",a)},A8=function(a){x8("setCastInstalled_ "+a);
g.wz("yt-remote-cast-installed",a)},E8=function(){return!!g.Ha("yt.mdx.remote.cloudview.apiReady_")},nSa=function(a){x8("setApiReady_ "+a);
...
this.Ra=0;this.B=a;this.D=[];this.C=new tRa;this.u=this.i=null;this.N=(0,g.D)(this.JS,this);this.J=(0,g.D)(this.Tv,this);this.K=(0,g.D)(this.IS,this);this.V=(0,g.D)(this.QS,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.UE,this),sSa(this))):c=3;0!=c&&(b?this.UE(c):g.et((0,g.D)(function(){this.UE(c)},this),0));
(a=qSa())&&O8(this,a);this.subscribe("yt-remote-cast2-session-change",this.V)},Q8=function(a){return new H8(a.B.getPlayerContextData())},sSa=function(a){g.Db("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled".split(" "),function(b){this.D.push(this.B.subscribe(b,g.Pa(this.iU,b),this))},a)},tSa=function(a){g.Db(a.D,function(b){this.B.unsubscribeByKey(b)},a);
...
a.B.setPlayerContextData(N8(b));sSa(a)},O8=function(a,b){a.u&&(a.u.removeUpdateListener(a.N),a.u.removeMediaListener(a.J),a.Tv(null));
a.u=b;a.u&&(S7("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.N),a.u.addMediaListener(a.J),a.u.media.length&&a.Tv(a.u.media[0]))},uSa=function(a){var b=a.i.media,c=a.i.customData;
...
if(b){var d=wSa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ga("yt.mdx.remote.remoteClient_",c,void 0);b&&($8(a),a9(a));c=N7(a.i)&&isNaN(a.D);b==c?b&&(Z8(a,1),c9(a,"getSubtitlesTrack")):b?(a.aJ()&&a.jc.reset(),Z8(a,1),c9(a,"getNowPlaying"),zSa(a)):a.yr(1)},BSa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.jc.videoId&&(g.Wb(b.params)?a.jc.trackData=null:a.jc.trackData=b.params,a.Z("remotePlayerChange"))},CSa=function(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);
a.jc.listId=b.params.listId||a.jc.listId;M8(a.jc,c,d);a.Z("remoteQueueChange")},ESa=function(a,b){b.params=b.params||{};
CSa(a,b);DSa(a,b);a.Z("autoplayDismissed")},DSa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
K8(a.jc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.jc.playerState&&(c=-1E3);a.jc.playerState=c;c=Number(b.params.loadedTime);a.jc.N=isNaN(c)?0:c;a.jc.Ej(Number(b.params.duration));c=a.jc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.jc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.jc.playerState?ySa(a):b9(a);a.Z("remotePlayerChange")},FSa=function(a,b){if(-1E3!=a.jc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.jc.playerState=c;b=parseInt(b.params.currentTime,10);K8(a.jc,isNaN(b)?0:b);a.Z("remotePlayerChange")}},GSa=function(a,b){var c="true"==b.params.muted;
a.jc.volume=parseInt(b.params.volume,10);a.jc.muted=c;a.Z("remotePlayerChange")},HSa=function(a,b){a.J=b.params.videoId;
a.Z("nowAutoplaying",parseInt(b.params.timeout,10))},ISa=function(a,b){var c="true"==b.params.hasNext;
a.jc.Ak="true"==b.params.hasPrevious;a.jc.hasNext=c;a.Z("previousNextChange")},zSa=function(a){g.gt(a.N);
...
this.Ne=a;this.i=[];this.i.push(this.Ne.$_s("screenChange",(0,g.D)(this.eP,this)));this.i.push(this.Ne.$_s("onlineScreenChange",(0,g.D)(this.NT,this)))},MSa=function(a,b){IQa();
if(!e7||!e7.get("yt-remote-disable-remote-module-for-dev")){b=g.P("MDX_CONFIG")||b;AQa();c7();e9||(e9=new O7(b?b.loungeApiHost:void 0),JQa()&&(e9.i="/api/loungedev"));f9||(f9=g.Ha("yt.mdx.remote.deferredProxies_")||[],g.Ga("yt.mdx.remote.deferredProxies_",f9,void 0));JSa();var c=g9();if(!c){var d=new f8(e9,b?b.disableAutomaticScreenCache||!1:!1);g.Ga("yt.mdx.remote.screenService_",d,void 0);c=g9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ga("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);mSa(a,d,function(f){f?h9()&&G8(h9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){R6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ha("yt.mdx.remote.initialized_")&&(g.Ga("yt.mdx.remote.initialized_",!0,void 0),i9("Initializing: "+
...
R6("yt-remote-auto-connect","cast-selector-receiver")})),j9.push(g.Tu("yt-remote-cast2-receiver-resumed",function(){R6("yt-remote-receiver-resumed","cast-selector-receiver")})),j9.push(g.Tu("yt-remote-cast2-session-change",KSa)),j9.push(g.Tu("yt-remote-connection-change",function(f){f?G8(h9(),"YouTube TV"):l9()||(G8(null,null),pSa())})),j9.push(g.Tu("yt-remote-cast2-session-failed",function(){R6("yt-remote-connection-failed")})),a=m9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.hs("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),i9(" -- with channel params: "+g.Jh(a)),a?(g.wz("yt-remote-session-app",a.app),g.wz("yt-remote-session-name",a.name)):(g.zz("yt-remote-session-app"),g.zz("yt-remote-session-name")),g.Ga("yt.mdx.remote.channelParams_",a,void 0),c.start(),h9()||LSa())}},NSa=function(){var a=g9().Ne.$_gos();
...
v9=a?new d9(a):null}return v9},h9=function(){return g.Ha("yt.mdx.remote.currentScreenId_")},PSa=function(a){g.Ga("yt.mdx.remote.currentScreenId_",a,void 0)},QSa=function(){return g.Ha("yt.mdx.remote.connectData_")},k9=function(a){g.Ga("yt.mdx.remote.connectData_",a,void 0)},o9=function(){return g.Ha("yt.mdx.remote.connection_")},t9=function(a){var b=o9();
k9(null);a||PSa("");g.Ga("yt.mdx.remote.connection_",a,void 0);f9&&(g.Db(f9,function(c){c(a)}),f9.length=0);
...
n9()&&n9();if(w9)q9=a;else{PSa(a.id);var c=g.Ha("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new X8(e9,a,m9(),c);a.connect(b,QSa());a.subscribe("beforeDisconnect",function(d){R6("yt-remote-before-disconnect",d)});
...
var d=this;this.u=a;this.I=b;this.Rb=c;this.events=new g.ZM(this);this.ea=this.events.S(this.I,"onVolumeChange",function(e){RSa(d,e)});
...
a=this.Rb;a.isDisposed();a.subscribe("proxyStateChange",this.lL,this);a.subscribe("remotePlayerChange",this.Yv,this);a.subscribe("remoteQueueChange",this.sz,this);a.subscribe("previousNextChange",this.iL,this);a.subscribe("nowAutoplaying",this.cL,this);a.subscribe("autoplayDismissed",this.FK,this);g.J(this,this.i);g.J(this,this.B);g.J(this,this.N);g.J(this,this.V);g.J(this,this.K);this.sM();this.sz();this.Yv()},RSa=function(a,b){if(y9(a)){a.Rb.unsubscribe("remotePlayerChange",a.Yv,a);
var c=Math.round(b.volume);b=!!b.muted;var d=Q8(a.Rb);if(c!==d.volume||b!==d.muted)a.Rb.setVolume(c,b),a.V.start();a.Rb.subscribe("remotePlayerChange",a.Yv,a)}},SSa=function(a){a.Ob(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.Rb.playVideo(c.videoId,b,d,e,c.playerParams,c.Ta,pQa(c));a.Sb(new g.dK(1))},TSa=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{yJ:1});
...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},T:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",T:[{G:"div",L:"ytp-mdx-popup-title",va:"You're signed out"},{G:"div",L:"ytp-mdx-popup-description",va:"Videos that you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",T:[{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"Cancel"},{G:"button",Ga:["ytp-button",
...
L:"ytp-remote",T:[{G:"div",L:"ytp-remote-display-status",T:[{G:"div",L:"ytp-remote-display-status-icon",T:[g.Mra()]},{G:"div",L:"ytp-remote-display-status-text",va:"{{statustext}}"}]}]});this.api=a;this.i=new g.JL(this,250);g.J(this,this.i);this.S(a,"presentingplayerstatechange",this.u);USa(this,a.vb())},USa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
...
!g.T(this.player.U().experiments,"deprecate_pair_servlet_enabled")&&(this.hs=new B9,g.J(this,this.hs),g.WM(a,this.hs.element,4));this.ew=!!l9();this.Ry=!!g.xz("yt-remote-manual-pairing-warning-shown")}},G9=function(a){a.dm&&(a.player.removeEventListener("presentingplayerstatechange",a.dm),a.dm=null)},VSa=function(a,b,c){a.qd=c;
a.player.Z("presentingplayerstatechange",new g.oI(c,b))},WSa=function(a,b,c){var d=!1;
1===b?d=!a.ew:2===b&&(d=!a.Ry);d&&g.qI(c,8)&&(a.player.pauseVideo(),G9(a))},H9=function(a,b){if(b.key!==a.Nm.key)if(b.key===a.qj.key)r9();
else{if(a.hs&&!a.Ry&&b!==a.qj&&"cast-selector-receiver"!==b.key&&g.JF(a.player.U()))XSa(a);else{var c;(c=!g.T(a.player.U().experiments,"mdx_enable_privacy_disclosure_ui"))||(c=((c=g.P("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.P("SESSION_INDEX")&&!g.P("LOGGED_IN")))||a.ew||!a.Cs);(c?0:g.JF(a.player.U())||g.MF(a.player.U()))&&YSa(a)}a.Nm=b;if(!a.player.U().Y("disable_mdx_connection_in_mdx_module_for_music_web")||!g.tF(a.player.U())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);
...
g.Jh(b));"cast-selector-receiver"==b.key?(k9(a||null),b=a||null,E8()?B8().setLaunchParams(b):z8("setLaunchParams called before ready.")):!a&&u9()&&h9()==b.key?R6("yt-remote-connection-change",!0):(r9(),k9(a||null),a=g9().Hh(),(b=Z6(a,b.key))&&s9(b,1))}}},YSa=function(a){a.player.vb().yc()?a.player.pauseVideo():(a.dm=function(b){WSa(a,1,b)},a.player.addEventListener("presentingplayerstatechange",a.dm));
a.Cs&&a.Cs.bd();o9()||(w9=!0)},XSa=function(a){a.player.vb().yc()?a.player.pauseVideo():(a.dm=function(b){WSa(a,2,b)},a.player.addEventListener("presentingplayerstatechange",a.dm));
a.hs&&a.hs.bd();o9()||(w9=!0)},YQa={"\x00":"\\0",
"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\x0B":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},w7={"'":"\\'"},vQa={AX:"atp",P7:"ska",D6:"que",M4:"mus",O7:"sus",V0:"dsp",Y6:"seq",p4:"mic",S_:"dpa",PX:"cds",K4:"mlm"},e7,a7="",PQa=KQa("loadCastFramework")||KQa("loadCastApplicationFramework"),RQa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
g.k.mV=function(){this.gt=null;var a=Date.now();0<=a-this.JF?(2!=this.Ss&&this.i.tj(3),u7(this),this.Cm=2,p7(18),v7(this)):$Qa(this,this.JF-a)};
g.k.getLastError=function(){return this.Cm};g.k=cRa.prototype;g.k.mB=null;g.k.nh=null;g.k.Lz=!1;g.k.nM=null;g.k.Mx=null;g.k.zD=null;g.k.nB=null;g.k.Ra=null;g.k.Xk=-1;g.k.Mt=null;g.k.mu=null;g.k.connect=function(a){this.nB=a;a=A7(this.i,null,this.nB);p7(3);this.nM=Date.now();var b=this.i.K;null!=b?(this.Mt=b[0],(this.mu=b[1])?(this.Ra=1,dRa(this)):(this.Ra=2,C7(this))):(O6(a,"MODE","init"),this.nh=new q7(this,void 0,void 0,void 0),this.nh.Go=this.mB,r7(this.nh,a,!1,null,!0),this.Ra=0)};
...
g.k.fx=function(){this.Xk=this.nh.Lt;if(this.nh.pm)0==this.Ra?this.mu?(this.Ra=1,dRa(this)):(this.Ra=2,C7(this)):2==this.Ra&&((!g.ke||g.ce(10)?!this.Lz:200>this.zD-this.Mx)?(p7(11),B7(this.i,this,!1)):(p7(12),B7(this.i,this,!0)));else{0==this.Ra?p7(9):2==this.Ra&&p7(10);var a=this.i;this.nh.getLastError();a.Wj=this.Xk;J7(a,2)}};
g.k.Dw=function(){return this.i.Dw()};
g.k.isActive=function(){return this.i.isActive()};
g.k.tj=function(a){this.i.tj(a)};g.k=D7.prototype;g.k.Vj=null;g.k.Ku=null;g.k.Ug=null;g.k.De=null;g.k.oB=null;g.k.Nx=null;g.k.MH=null;g.k.gx=null;g.k.Mv=0;g.k.XR=0;g.k.Jf=null;g.k.Um=null;g.k.ul=null;g.k.kp=null;g.k.Lm=null;g.k.tA=null;g.k.Wr=-1;g.k.WJ=-1;g.k.Wj=-1;g.k.Dr=0;g.k.dr=0;g.k.Zo=8;g.Ra(fRa,g.nf);g.Ra(gRa,g.nf);g.k=D7.prototype;g.k.connect=function(a,b,c,d,e){p7(0);this.oB=b;this.Ku=c||{};d&&void 0!==e&&(this.Ku.OSID=d,this.Ku.OAID=e);this.D?(n7((0,g.D)(this.hI,this,a),100),kRa(this)):this.hI(a)};
g.k.hI=function(a){this.Lm=new cRa(this);this.Lm.mB=this.Vj;this.Lm.u=this.C;this.Lm.connect(a)};
g.k.hf=function(){return 0==this.Ra};
g.k.getState=function(){return this.Ra};
g.k.rL=function(a){this.Um=null;oRa(this,a)};
g.k.qL=function(){this.ul=null;this.De=new q7(this,this.u,"rpc",this.J);this.De.Go=this.Vj;this.De.lB=0;var a=this.MH.clone();g.Yj(a,"RID","rpc");g.Yj(a,"SID",this.u);g.Yj(a,"CI",this.tA?"0":"1");g.Yj(a,"AID",this.Wr);E7(this,a);if(!g.ke||g.ce(10))g.Yj(a,"TYPE","xmlhttp"),r7(this.De,a,!0,this.gx,!1);else{g.Yj(a,"TYPE","html");var b=this.De,c=!!this.gx;b.Ss=3;b.Gm=N6(a.clone());ZQa(b,c)}};
...
a&&G7(this),!g.vc(b))for(a=this.C.parse(b),b=0;b<a.length;b++)c=a[b],this.Wr=c[0],c=c[1],2==this.Ra?"c"==c[0]?(this.u=c[1],this.gx=c[2],c=c[3],null!=c?this.Zo=c:this.Zo=6,this.Ra=3,this.Jf&&this.Jf.dI(),this.MH=A7(this,this.Dw()?this.gx:null,this.oB),pRa(this)):"stop"==c[0]&&J7(this,7):3==this.Ra&&("stop"==c[0]?J7(this,7):"noop"!=c[0]&&this.Jf&&this.Jf.cI(c),this.dr=0)};
g.k.CS=function(){null!=this.kp&&(this.kp=null,this.De.cancel(),this.De=null,I7(this),p7(20))};
g.k.fx=function(a){if(this.De==a){G7(this);this.De=null;var b=2}else if(this.Ug==a)this.Ug=null,b=1;else return;this.Wj=a.Lt;if(0!=this.Ra)if(a.pm)if(1==b){b=Date.now()-a.Hs;var c=o7;c.dispatchEvent(new fRa(c,a.eq?a.eq.length:0,b,this.Dr));F7(this);this.B.length=0}else pRa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Wj)){if(d=1==b)this.Ug||this.Um||1==this.Ra||2<=this.Dr?d=!1:(this.Um=n7((0,g.D)(this.rL,this,a),qRa(this,this.Dr)),this.Dr++,d=!0);d=!(d||2==b&&I7(this))}if(d)switch(c){case 1:J7(this,
...
g.k.iW=function(a){a?p7(2):(p7(1),rRa(this,8))};
...
g.k.tj=function(a){var b=o7;b.dispatchEvent(new gRa(b,a))};
g.k.Dw=function(){return!(!g.ke||g.ce(10))};
g.k=sRa.prototype;g.k.dI=function(){};
g.k.cI=function(){};
g.k.bI=function(){};
g.k.bC=function(){};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Pf=5E3};g.Ra(L7,sRa);g.k=L7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.ea||(this.ea=!0,g.hf(this.B),wRa(this),g.hf(this.u),this.u=null,this.ma=function(){return""})};
g.k.isDisposed=function(){return this.ea};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.V="";this.u.stop();this.D=a||null;this.C=b||0;a=this.xa+"/test";b=this.xa+"/bind";var d=new D7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Jf=null);d.Jf=this;this.i=d;M7(this);if(this.i){d=g.P("ID_TOKEN");var f=this.i.Vj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Vj=f}e?(3!=e.getState()&&0==mRa(e)||e.getState(),this.i.connect(a,b,this.J,e.u,e.Wr)):c?this.i.connect(a,
b,this.J,c.sessionId,c.arrayId):this.i.connect(a,b,this.J)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.dc(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):N7(this)&&(M7(this),lRa(this.i,a))};
g.k.dI=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)lRa(this.i,a[b])}this.Z("handlerOpened")};
...
g.k.cI=function(a){"S"==a[0]?this.V=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),jRa(this.i)):this.Z("handlerMessage",new uRa(a[0],a[1]))};
...
g.k.NV=function(){this.u.isActive();0==mRa(this.i)&&this.connect(this.D,this.C)};O7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
O7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
O7.prototype.D=function(a){a(Error("request timed out"))};var DRa=Date.now(),R7=null,U7=Array(50),T7=-1,V7=!1;g.Ra(W7,g.R);W7.prototype.Hh=function(){return this.screens};
...
g.k.VO=function(a){this.i=null;a.status&&404==a.status?this.u>=ZSa.length?this.Z("pairingFailed",Error("DIAL polling timed out")):(a=ZSa[this.u],this.Kb=g.et((0,g.D)(this.AL,this),a),this.u++):this.Z("pairingFailed",Error("Server error "+a.status))};
g.k.XO=function(){this.i=null;this.Z("pairingFailed",Error("Server not responding"))};
var ZSa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ra(Z7,W7);g.k=Z7.prototype;g.k.start=function(){Y7(this)&&this.Z("screenChange");!g.xz("yt-remote-lounge-token-expiration")&&HRa(this);g.gt(this.i);this.i=g.et((0,g.D)(this.start,this),1E4)};
g.k.add=function(a,b){Y7(this);ERa(this,a);$7(this,!1);this.Z("screenChange");b(a);a.token||HRa(this)};
g.k.remove=function(a,b){var c=Y7(this);GRa(this,a)&&($7(this,!1),c=!0);b(a);c&&this.Z("screenChange")};
...
g.k.FE=function(){g.gt(this.B);this.B=NaN;this.u&&this.u.abort();var a=JRa(this);if(P6(a)){var b=P7(this.D,"/pairing/get_screen_availability");this.u=Q7(this.D,b,{lounge_token:g.Ob(a).join(",")},(0,g.D)(this.EU,this,a),(0,g.D)(this.DU,this))}else d8(this,{}),e8(this)};
g.k.EU=function(a,b){this.u=null;var c=g.Ob(JRa(this));if(g.Bb(c,g.Ob(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;d8(this,c);e8(this)}else this.Zd("Changing Screen set during request."),this.FE()};
...
g.k.YO=function(a,b,c,d){g.lt(P7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.D)(function(e,f){e=new T6(f.screen||{});if(!e.name||NRa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);NRa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(g8(this,e))},this),
...
g.k.VQ=function(){PRa(this);this.Z("screenChange");this.i.update()};
...
g.k.ya=function(){this.SE("");i8.Yd.ya.call(this)};g.w(l8,i8);g.k=l8.prototype;g.k.RE=function(a){if(this.u){if(this.u==a)return;k8(this,"Overriding cast session with new session object");YRa(this);this.xa=!1;this.V="unknown";this.u.removeUpdateListener(this.ma);this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa)}this.u=a;this.u.addUpdateListener(this.ma);this.u.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa);URa(this,"getMdxSessionStatus")};
...
g.k.SE=function(){};
g.k.ya=function(){this.info("disposeInternal");YRa(this);this.u&&(this.u.removeUpdateListener(this.ma),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;i8.prototype.ya.call(this)};
g.k.pV=function(a,b){if(!this.isDisposed())if(b)if(b=Q6(b),g.Ma(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.Jh(b)),a){case "mdxSessionStatus":SRa(this,b);break;case "loungeToken":VRa(this,b);break;default:k8(this,"Unknown youtube message: "+a)}else k8(this,"Unable to parse message.");else k8(this,"No data in message.")};
g.k.cJ=function(a,b,c,d){g.gt(this.N);this.N=0;MRa(this.B,this.i.label,a,this.i.friendlyName,(0,g.D)(function(e){e?b(e):0<=d?(k8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.N=g.et((0,g.D)(this.cJ,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){eSa(this);this.u?this.u.stop((0,g.D)(this.wg,this,null),(0,g.D)(this.wg,this,"Failed to stop DIAL device.")):this.wg()};
g.k.ya=function(){eSa(this);this.u&&this.u.removeUpdateListener(this.Ha);this.u=null;i8.prototype.ya.call(this)};
...
(chrome.cast.addReceiverActionListener(this.D),ARa(),this.u.subscribe("onlineScreenChange",(0,g.D)(this.KG,this)),this.B=hSa(this),chrome.cast.setCustomReceivers(this.B,g.Ia,(0,g.D)(function(f){this.Zd("Failed to set initial custom receivers: "+g.Jh(f))},this)),this.Z("yt-remote-cast2-availability-change",v8(this)),b(!0))},this),(0,g.D)(function(f){this.Zd("Failed to initialize API: "+g.Jh(f));
b(!1)},this))};
g.k.SV=function(a,b){u8("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)u8("Unsetting old screen status: "+this.i.i.friendlyName),w8(this,null)}if(a&&b){if(!this.i){c=Z6(this.u.Hh(),a);if(!c){u8("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){u8("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=fSa(this,c);a||(u8("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.ya=function(){this.u.unsubscribe("onlineScreenChange",(0,g.D)(this.KG,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=xRa,b=g.Ha("yt.mdx.remote.debug.handlers_");g.ob(b||[],a);g.hf(this.i);g.R.prototype.ya.call(this)};
...
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.ms(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=cSa(b,c)):a=cSa(b,c)):a=r8(b);return a};
...
g.k.KG=function(){this.isDisposed()||(this.B=hSa(this),u8("Updating custom receivers: "+g.Jh(this.B)),chrome.cast.setCustomReceivers(this.B,g.Ia,(0,g.D)(function(){this.Zd("Failed to set custom receivers.")},this)),this.Z("yt-remote-cast2-availability-change",v8(this)))};
...
g.k.ya=function(){tSa(this);this.B=null;this.C.clear();O8(this,null);g.R.prototype.ya.call(this)};
...
g.k.Tv=function(a){S7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.K);if(this.i=a)this.i.addUpdateListener(this.K),uSa(this),this.Z("remotePlayerChange")};
g.k.IS=function(a){a?(uSa(this),this.Z("remotePlayerChange")):this.Tv(null)};
g.k.nF=function(){V8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.QS=function(){var a=qSa();a&&O8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ca?"setInitialState":"setPlaylist";Y8("Connecting with "+c+" and params: "+g.Jh(m));this.i.connect({method:c,params:g.Jh(m)},a,DQa())}else Y8("Connecting without params"),this.i.connect({},a,DQa());xSa(this)};
...
ASa(this,a);a=this.JJ("mlm");this.Z("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.pb(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
ASa(this,!1);break;case "remoteConnected":var b=new S6(Q6(a.params.device));g.fb(this.u,function(c){return b?c.id==b.id:!1})||qQa(this.u,b);
...
a.params.autoplayMode;this.Z("autoplayModeChange",this.C);"DISABLED"==this.C&&this.Z("autoplayDismissed");break;case "onHasPreviousNextChanged":ISa(this,a);break;case "requestAssistedSignIn":this.Z("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.Z("loopModeChange",a.params.loopMode);break;default:Y8("Unrecognized action: "+a.action)}};
...
g.k.yr=function(a){Y8("Disconnecting with "+a);g.Ga("yt.mdx.remote.remoteClient_",null,void 0);$8(this);this.Z("beforeDisconnect",a);1==a&&d7();wRa(this.i,a);this.dispose()};
...
g.k.RV=function(a,b){c9(this,a,b);zSa(this)};
...
g.k.wT=function(){g.Wb(this.C)||TSa(this,this.C);this.D=!1};
...
g.k.VM=function(){var a=this;if(y9(this)){var b=Q8(this.Rb);this.events.kc(this.ea);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.ea=this.events.S(this.I,"onVolumeChange",function(c){RSa(a,c)})}};
...
g.k.Sb=function(a){this.B.stop();var b=this.J;if(!g.iK(b,a)){var c=g.V(a,2);c!==g.V(this.J,2)&&this.I.Ls(c);this.J=a;VSa(this.u,b,a)}};g.w(B9,g.W);B9.prototype.bd=function(){this.i.show()};
...
g.k.load=function(){this.player.cancelPlayback();g.iN.prototype.load.call(this);this.yh=new x9(this,this.player,this.Rb);var a=(a=QSa())?a.currentTime:0;var b=u9()?new P8(o9(),void 0):null;0==a&&b&&(a=L8(Q8(b)));0!==a&&this.Ob(a);VSa(this,this.qd,this.qd);this.player.Ok(6)};
...
g.k.kL=function(){var a=[this.qj],b=a.concat,c=NSa();D8()&&g.xz("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Sn=b.call(a,c);a=p9()||this.qj;H9(this,a);this.player.Ma("onMdxReceiversChange")};
